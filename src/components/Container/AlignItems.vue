                ...
                <div class="col-12 col-xl-5">
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="alignItems"
                                   id="align-item-stretch"
                                   value="stretch">
                            <label class="form-check-label" for="align-item-stretch">
                                baseline: 默认值，占满整个容器。
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="alignItems" id="align-item-flex-start"
                                   value="flex-start"
                                   checked>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="alignItems" id="align-item-flex-end"
                                   value="flex-end">
                            <label class="form-check-label" for="align-item-flex-end">
                                flex-end: 项目从“箭头”结尾处开始对齐。
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="alignItems" id="align-item-center"
                                   value="center">
                            <label class="form-check-label" for="align-item-center">
                                center: 项目居中对齐
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="alignItems"
                                   id="align-item-space-between"
                                   value="baseline">
                            <label class="form-check-label" for="align-item-space-between">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="justifyContent" id="flex-start"
                                   value="flex-start"
                                   checked>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="justifyContent" id="flex-end"
                                   value="flex-end">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="justifyContent" id="center"
                                   value="center">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="justifyContent" id="space-between"
                                   value="space-between">
                            <label class="form-check-label" for="space-between">
                                space-between: 项目两端对齐
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" v-model="justifyContent" id="space-around"
                                   value="space-around">
                            <label class="form-check-label" for="space-around">
                                space-around: 项目两端留空对齐
                            </label>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea v-model="cssCode" style="height: 160px" class="form-control" id="cssCode"
                                  readonly></textarea>
                    </div>
                        ...
                        <div class="d-flex">
                            <div id="box-wrapper" class="box d-flex flex-column align-items-center"
                                ...
                                <div class="boxes d-flex w-100 h-100"
                                     :style="{ flexDirection: direction ,justifyContent:justifyContent, alignItems:alignItems}">
