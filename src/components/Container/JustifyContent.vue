      ...
      <div class="row">
        <div class="col-12 col-xl-5">
          <div class="mb-3">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" v-model="justifyContent" id="center" value="center">
          ...
          <div class="form-group mb-4">
            ...
            <textarea v-model="cssCode" style="height: 130px" class="form-control" id="cssCode"
                      readonly></textarea>
          </div>
