<template>
  <div>
    <div>
      <h2>1.2 相对性</h2>
      <p class="lead">多层嵌套的情况下，中间的元素既是"容器"也是"项目"。
      ...
      <div class="row">
        <div class="col-12 col-xl-5">
          <div class="form-group">
            ...
            <textarea ref="htmlCode" v-model="htmlCode" class="form-control" id="exampleFormControlTextarea1"
  ...
  export default {
    ...
    methods: {
      updateHtmlCode() {
        ...
        this.htmlCode += "\n";
        this.htmlCode += '</div>';
        if (this.$refs.htmlCode) this.htmlCodeHeight = this.$refs.htmlCode.scrollHeight + 60;
      },
      //移入
